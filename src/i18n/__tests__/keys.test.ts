...
const REQUIRED = ['login.sendOtp','home.tapCheckIn','attendance.checkIn','nav.home','role.conductor.onBoard','trip.viewMap','trip.locationDenied','trip.live','trip.nextStop','trip.viewStudents','trip.studentsExpected','trip.lastUpdate','trip.delayed','trip.offline','trip.recenter','trip.etaMin','trip.distanceKm','trip.distanceM','trip.routeSegment','trip.routeSegmentDistance'];
